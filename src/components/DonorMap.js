...
import { GoogleMap, LoadScript, InfoWindow, Marker } from '@react-google-maps/api';  // Import Marker
import { db } from '../firebaseConfig'; // Import Firestore configuration
import { collection, getDocs } from 'firebase/firestore';
import SearchLocationInput from '../components/GooglePlacesApi';  // Ensure this path is correct
    ...
    return (
        <div className="flex flex-col items-center p-6">
            ...
            <div className="mb-4 w-full max-w-md">
                <SearchLocationInput
                    setSelectedLocation={handleLocationChange}  // Pass the function to handle location change
                    setSelectedAddress={setSelectedAddress}  // Pass the function to handle address change
                />
            </div>
            ...
            <div className="w-full h-96 mb-4">
                <LoadScript
                    ...
                    libraries={['places']} // Ensure necessary libraries are included
                    onLoad={() => setGoogleLoaded(true)}  // Callback when script is loaded
                >
                    <GoogleMap
                    ...
                    >
                        {/* Only render markers if google is loaded */}
                        {googleLoaded && filteredShelters.map((shelter, index) => {
                            return (
                                <Marker
                                    ...
                                    icon={{
                                        url: "http://maps.google.com/mapfiles/ms/icons/red-dot.png",  // Icon URL
                                    }}
                                />
                            );
                        })}
